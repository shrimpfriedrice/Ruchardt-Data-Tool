...
previousMassVal = 210.0 #211 for h2s2 210 for rest
aD = 0.5
tC = 0
#cap = cv2.VideoCapture('heatedrun3session2.MOV')

ix, iy = -1, -1
threshold = 150 #150 for h3s2, 180 for rest, 140 for u2s3
...
pkl_output_file = open(file_select+'index', 'rb')
